...
$showError = false;
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if($password == $cpassword){
            ...
            $sql = "INSERT INTO `user` (`name`, `email`, `phone`, `password`, `date`) VALUES ('$username', '$email', '$phone', '$hash', current_timestamp())";
  ...
  <body>
    ...
    <?php 
        if($showArt){
            ...
            <strong>Successfull!</strong> Sign Up complete, Please Login to continue...
    ...
    <div class="container">
        ...
        <form action="./signup.php" method="post">
            ...
            <div class="mb-3">
                ...
                <div id="emailHelp" class="form-text">Both password must be same.</div>
            </div>
